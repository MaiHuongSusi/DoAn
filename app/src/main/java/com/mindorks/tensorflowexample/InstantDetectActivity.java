...
public class InstantDetectActivity extends AppCompatActivity implements ImageReader.OnImageAvailableListener, CameraFragment.ConnectionCallback, TextToSpeech.OnInitListener {

    public static final String TAG = "InstantDetectActivity";
    ...
    private LinearLayout btnChoose, btnCapture;
    Dialog dialog;
    String detail;
    Uri imageUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instant_detect);
        ...
        btnChoose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gallary = new Intent(InstantDetectActivity.this, ChooseImageActivity.class);
        ...
        btnCapture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent capture = new Intent(InstantDetectActivity.this, CaptureActivity.class);
    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA) || shouldShowRequestPermissionRationale(PERMISSION_STORAGE)) {
                Toast.makeText(InstantDetectActivity.this, "Camera AND storage permission are required for this demo", Toast.LENGTH_LONG).show();
            }
