...
//        Toast.makeText( this, "Size : " + listPro.size(), Toast.LENGTH_LONG ).show();
    ...
    private void initCategory(){
        Category catAnimal = new Category("Animal", R.drawable.animal);
        Category catPlant = new Category( "Plant", R.drawable.planthouse);
        Category catFur = new Category( "Furniture", R.drawable.furniture);
        Category catFruit = new Category( "Fruit",  R.drawable.fruit);
